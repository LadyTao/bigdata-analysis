-- shencut's background database:store In IP: 192.168.11.43  port:3306  user:vp_store_read  passwd:ppYDC##821348
...
inputtime
from wx_order
where  status in (10,20)) t1
left join
wx_member t2
on t1.uid= t2.uid
left join
wx_marketing_channel t3
