...
if __name__ == "__main__":
    ...
    active_day_sql = """
                ...
                count(devid) as increase
                from
                base.device_filmora_win where   day= '__DAY1__' AND  last_active = '__DAY1__' and  app_version is not null
                group by
                last_active,
                app_version
                ...
                count(devid) as increase
                from
                base.device_filmora_mac where   day= '__DAY1__' AND last_active = '__DAY1__' and  app_version is not null
                group by
                last_active,
                app_version
                order by last_active desc
