...
if __name__ == "__main__":
    ...
    device_total_sql = """
        select 
            '__DAY1__' as stat_date,
            '__DAY1__' as show_date,
            'filmora_win' as dev_type,
            app_version,
            count(devid) as  total_amount
        ...
        union all
            ...
            app_version,
            count(devid) as total_amount
            from base.device_filmora_mac where app_version is not null and day='__DAY1__'
            GROUP BY app_version
        union all
            select 
            '__DAY1__' as stat_date,
            ...
            app_version,
            count(devid) as  total_amount
            from base.device_shencut_win where app_version is not null and day='__DAY1__'
            GROUP BY app_version
        union all
            select 
            '__DAY1__' as stat_date,
            ...
            app_version,
            count(devid) as total_amount
            from base.device_shencut_mac where app_version is not null and day='__DAY1__'
            GROUP BY app_version
    ...
    if time_type == 'day':
        device_total_sql = job_day(date=excute_date,
                            moudle_sql=device_total_sql)
        print("begin to insert table device_total_day")
        insert_into_mysql(sql_query=device_total_sql, sql_session=sparksession,
