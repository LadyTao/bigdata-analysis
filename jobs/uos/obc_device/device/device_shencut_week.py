...
if __name__ == "__main__":
    ...
    (
            ...
            count(devid) as increase
            from
            base.device_shencut_win where  first_active between date_sub('__DAY1__' ,7) and date_sub('__DAY1__' ,1)  AND app_version is not null
            group by
            date_sub(next_day(date_sub(first_active,1),'MO'),7),
            app_version
            ) week  order by week.stat_date desc
    ...
    (
            ...
            count(devid) as increase
            from
            base.device_shencut_mac where   first_active between date_sub('__DAY1__' ,7) and date_sub('__DAY1__' ,1)   AND app_version is not null
            group by
            date_sub(next_day(date_sub(first_active,1),'MO'),7),
            app_version
            ) week  order by week.stat_date desc
    ...
    active_week_sql = """
            ...
            (
                ...
                count(devid) as increase
                from
                base.device_shencut_win where last_active between date_sub('__DAY1__' ,7) and date_sub('__DAY1__' ,1) AND app_version is not null
                group by
                date_sub(next_day(date_sub(last_active,1),'MO'),7),
                app_version
                ) week  order by week.stat_date desc
            ...
            (        select
                ...
                count(devid) as increase
                from
                base.device_shencut_mac where   last_active between date_sub('__DAY1__' ,7) and date_sub('__DAY1__' ,1) AND  app_version is not null
                group by
                date_sub(next_day(date_sub(last_active,1),'MO'),7),
                app_version
                ) week  order by week.stat_date desc
